...
def recommend():
    ...
    if 'main' in weather_data:
        ...
        weather_description = weather_data['weather'][0]['description']  # Get weather description

        # Print temperature and humidity for debugging
        print(f'Temperature: {temperature}, Humidity: {humidity}, Weather: {weather_description}')
    else:
